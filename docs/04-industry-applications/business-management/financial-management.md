...
**定理 4.3.3.2.1.1 (NPV决策准则)**:

- $NPV > 0$: 接受项目
- $NPV < 0$: 拒绝项目
- $NPV = 0$: 无差异

**示例 4.3.3.2.1.1 (NPV计算)**:
...
**定义 4.3.3.2.2.1 (内部收益率)**
内部收益率 $IRR$ 是使 $NPV = 0$ 的折现率：

$$\sum_{t=0}^T \frac{CF_t}{(1+IRR)^t} = I_0$$

**定理 4.3.3.2.2.1 (IRR决策准则)**:

- $IRR > r$: 接受项目
- $IRR < r$: 拒绝项目
- $IRR = r$: 无差异

**示例 4.3.3.2.2.1 (IRR计算)**:
...
**定理 4.3.3.4.2.1 (投资组合收益)**
$$R_p = \sum_{i=1}^n w_i R_i$$

**定理 4.3.3.4.2.2 (投资组合风险)**
$$\sigma_p^2 = \sum_{i=1}^n \sum_{j=1}^n w_i w_j \sigma_{ij}$$

**示例 4.3.3.4.2.1 (投资组合优化)**:
...
**定义 4.3.3.4.3.1 (Black-Scholes模型)**
期权定价公式：
...
5. IFRS Foundation. (2023). International Financial Reporting Standards (IFRS).
